##### FUNCTION 1 - Create Timeseries Plot

# Function for creating state transition plots from a dataframe
# Parameters:
#   - df: Input dataframe containing data for state transitions
#   - sample_size: Fraction of the dataset to sample (default is 0.2)
#   - line_plot: Boolean flag to determine whether to create a line plot (default is NULL)
#   - cellid_column: Name of the column containing cell IDs
#   - time_column: Name of the column containing timestamps
# Returns:
#   - A plotly plot object representing the state transition plot
...
##### FUNCTION 2 - Create Transition Probability Table

# Function for calculating transition probabilities for each Cell.ID in a dataframe
# Parameters:
#   - df: Input dataframe containing data for transition probabilities
#   - cellid_column: Name of the column containing cell IDs
#   - time_column: Name of the column containing timestamps
# Output:
#   - Prints and stores a list of dataframes with transition probabilities
...
##### FUNCTION 3 - Function for Reconciliation of Transition Probability - Model Diagnostics

# Function for creating transition probability heatmaps and reconciling them
# Parameters:
#   - df: Input dataframe containing data for transition probabilities
#   - hmap_type: Type of heatmap to generate ('with_self_state', 'without_self_state', or 'All')
#   - cellid_column: Name of the column containing cell IDs
#   - time_column: Name of the column containing timestamps
# Returns:
...
##### FUNCTION 4 - Create Flow map

# Function for generating flow maps and animations based on transition probabilities
# Parameters:
#   - hvt_model_output: Output from a Hidden Markov Model (HMM) or other modeling approach
#   - transition_probability_df: Dataframe containing transition probability information
#   - hvt_plot_output: Output from a Hidden Variable Transition (HVT) model
#   - df: Input dataframe containing data for flow map generation
#   - animation: Type of animation ('state_based', 'time_based', or 'All')
#   - flow_map: Type of flow map ('with_self_state', 'without_self_state', 'self_state', 'probability', or 'All')
#   - animation_speed: Speed of animation (frames per second)
#   - threshold: Probability threshold for flow map arrows
#   - cellid_column: Name of the column containing cell IDs
#   - time_column: Name of the column containing timestamps
# Returns:
