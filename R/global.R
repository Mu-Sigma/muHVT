...
utils::globalVariables(c(".","k","Segment.Level","Segment.Child","Quant.Error",
                         ...
                         "Row.Number","identified_outlier_cells", "Cell.ID.x", "Cell.ID.y", "Layer1.Cell.ID", "Layer2.Cell.ID", "Segment.Child.x", "Segment.Child.y", "Segment.Level.x", "Segment.Level.y", "Segment.Parent.x", "Segment.Parent.y", "discard", "identified_Novelty_cells", "mapC_cell_path", "setnames"))