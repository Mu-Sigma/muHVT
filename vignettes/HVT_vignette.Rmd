...
.main-container {
  margin-left: 320px; /* Adjust this value to match the width of the TOC + some margin */
}
...
```{r torus plot,warning=FALSE,message=FALSE,fig.show="hold",fig.cap='Figure 2: 3D Torus',eval =TRUE,echo=TRUE, fig.width = 12,fig.height=7, fig.align='center'}
...
The table below shows summary of all numeric columns of
Dataset
...
```{r miss_value_column_level, warning=FALSE, purl = FALSE}
...
```{r dist_plots_true2, purl = FALSE,message=FALSE,warning=FALSE,fig.width = 12,fig.height=7, fig.align='center'}
...
```{r message=FALSE, warning=FALSE,results='asis',fig.width = 12,fig.height=7, fig.align='center'}
...
```{r Correlation, echo=FALSE,fig.width = 12,fig.height=7, fig.align='center',purl=FALSE}
...
```{r dist_plots_true23, purl = FALSE,message=FALSE,warning=FALSE,  fig.width = 12,fig.height=7, fig.align='center'}
...
```{r dist_plots_true234, purl = FALSE,message=FALSE,warning=FALSE, fig.width = 12,fig.height=7, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE, fig.width = 14,fig.height=8, fig.align='center',fig.cap='Figure 3: Sammons 1D x Cell ID plot for layer 1 shown for the 100 cells in the dataset ’torus’'}
plotHVT(heatmap = '1D')
```
...
```{r, warning=FALSE,message=FALSE, fig.width = 14,fig.height=8, fig.align='center',fig.cap='Figure 4: Sammons 1D x Cell ID plot for layer 1 shown for the 300 cells in the dataset ’torus’'}
plotHVT(heatmap = '1D')
```
...
```{r, warning=FALSE,message=FALSE, fig.width = 14,fig.height=8, fig.align='center',fig.cap='Figure 5: Sammons 1D x Cell ID plot for layer 1 shown for the 900 cells in the dataset ’torus’'}
plotHVT(heatmap = '1D')
```
...
```{r, warning=FALSE,message=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 6: Sammons 2D Plot for 100 cells'}
...
```{r, message=FALSE,warning=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 7: Sammons 2D Plot for 300 cells'}
...
```{r, warning=FALSE,message=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 8: Sammons 2D Plot for 900 cells'}
...
```{r, warning=FALSE,message=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 9: The Voronoi tessellation for layer 1 shown for the 100 cells in the dataset ’torus’'}
plotHVT(
  hvt.torus,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r, warning=FALSE,message=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 10: The Voronoi tessellation for layer 1 shown for the 300 cells in the dataset ’torus’'}
plotHVT(
  hvt.torus2,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r, warning=FALSE,message=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.cap='Figure 11: The Voronoi tessellation for layer 1 shown for the 900 cells in the dataset ’torus’'}
plotHVT(
  hvt.torus3,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r hmp level two quantization torus n demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 12: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for No. of entities in each cell in the ’torus’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus x demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 13: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable x in the ’torus’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus y demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 14: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable y in the ’torus’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus z demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 15: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable z in the ’torus’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 16: Mean Absolute Difference', fig.width = 12,fig.height=7, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE, fig.width = 14,fig.height=8, fig.align='center',fig.cap='Figure 17: Sammons 1D x Cell ID plot for layer 1 shown for the 450 cells in the dataset ’computers’'}
plotHVT(heatmap = '1D')
```
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 18: Sammons 2D Plot for 450 cells', fig.width = 12,fig.height=7, fig.align='center'}
...
```{r plot level one computers,warning=FALSE, fig.width = 12,fig.height=7, fig.align='center',fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 19: The Voronoi Tessellation for layer 1 shown for the 450 cells in the dataset ’computers’',eval = global_var}
...
```{r hmp level one n computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 20: The Voronoi Tessellation with the heat map overlaid over the No. of entities in each cell in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
...
```{r hmp level one price computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 21: The Voronoi Tessellation with the heat map overlaid over the variable price in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
...
```{r hmp level one hd computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 22: The Voronoi Tessellation with the heat map overlaid over the variable hd in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
...
```{r hmp level one ram computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 23: The Voronoi Tessellation with the heat map overlaid over the variable ram in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.results,
  trainComputers,
  child.level = 1,
...
```{r hmp level one screen computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 24: The Voronoi Tessellation with the heat map overlaid over the variable screen in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
plotHVT(
  hvt.results,
  trainComputers,
  child.level = 1,
...
```{r hmp level one ads computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 25: The Voronoi Tessellation with the heat map overlaid over the variable ads in the ’computers’ dataset',eval = global_var, fig.width = 12,fig.height=7, fig.align='center'}
...
**When `normalize` is set to TRUE while using `scoreHVT`, the function has an inbuilt feature to standardize the input testing dataset based on the mean and standard deviation of the training dataset from the `trainHVT` results.**
...
```{r,message=FALSE,warning=FALSE,fig.cap='Figure 26: Mean Absolute Difference', fig.width = 12,fig.height=7, fig.align='center'}
