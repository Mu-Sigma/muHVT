...
We will first split the torus data into train and test. We will use 9000 data points as train and remaining 3000 data points as test.
...
First of all, we will see the **raw training data containing (9000 data points)**. For the shake of brevity we are displaying first six rows.
...
Now, lets have a look at out **raw  testing dataset containing(3000 data points)**.For the shake of brevity we are displaying first six rows.


```{r}
test_dataset <- testTorus
test_dataset <- round(test_dataset,4)
test_dataset$Row.No <- row.names(test_dataset)
test_dataset <- test_dataset %>% dplyr::select(Row.No,x,y,z) 
rownames(test_dataset) <- NULL
Table(head(test_dataset))
```
...
centroid_coordinates <- centroid_coordinates %>% dplyr::select(Row.No,x,y)
...
Lets visualize the projected Sammons 2D onto a plane for all the 3 iterations.


```{r, warning=FALSE,message=FALSE,fig.cap='Figure 6: Sammons 2D Plot for 100,300,900 cells respectively'}
plot1 <- ggplot(centroid_coordinates1, aes(x, y)) +
  geom_point(color = "blue") +
  labs(x = "X", y = "Y")
plot2 <- ggplot(centroid_coordinates2, aes(x, y)) +
  geom_point(color = "blue") +
  labs(x = "X", y = "Y")
plot3 <- ggplot(centroid_coordinates3, aes(x, y)) +
  geom_point(color = "blue") +
  labs(x = "X", y = "Y")
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 7: The Voronoi tessellation for layer 1 shown for the 100 cells in the dataset ’torus’'}
muHVT::plotHVT(
  hvt.torus,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 8: The Voronoi tessellation for layer 1 shown for the 300 cells in the dataset ’torus’'}
muHVT::plotHVT(
  hvt.torus2,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 9: The Voronoi tessellation for layer 1 shown for the 900 cells in the dataset ’torus’'}
muHVT::plotHVT(
  hvt.torus3,
  line.width = c(0.4),
  color.vec = c("#141B41"),
...
```{r hmp level two quantization torus n demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 10: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for No. of entities in each cell in the ’torus’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus x demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 11: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable x in the ’torus’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus y demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 12: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable y in the ’torus’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
```{r hmp level two quantization torus z demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 13: The Voronoi tessellation for layer 1 and number of cells 900 with the heat map overlaid for variable z in the ’torus’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.torus3,
  torus_df,
  child.level = 1,
...
<!-- ```{r predictHVT pred torus,warning=FALSE,eval = global_var, eval=FALSE, echo=TRUE} -->
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 14: Mean Absolute Difference'}
hist(combined$diff, breaks = 10, col = "blue", main = "Mean Absolute Difference", xlab = "Difference")
```
...
Now, lets have a look at the **raw training dataset** containing (5007 data points). For the shake of brevity we are displaying first six rows.
...
Now, lets have a look at the **raw testing dataset** containing (1252 data points). For the shake of brevity we are displaying first six rows.
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 15: Sammons 2D Plot for 440 cells'}
# Assuming your sammons_data is a dataframe with columns "x" and "y"
ggplot(centroid_coordinates, aes(x, y)) +
  geom_point(color = "blue") +
  labs(x = "X", y = "Y")
...
```{r plot level one computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 16: The Voronoi Tessellation for layer 1 shown for the 440 cells in the dataset ’computers’',eval = global_var}
...
```{r hmp level one n computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 17: The Voronoi Tessellation with the heat map overlaid over the No. of entities in each cell in the ’computers’ dataset',eval = global_var}
...
```{r hmp level one price computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 18: The Voronoi Tessellation with the heat map overlaid over the variable price in the ’computers’ dataset',eval = global_var}
...
```{r hmp level one hd computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 19: The Voronoi Tessellation with the heat map overlaid over the variable hd in the ’computers’ dataset',eval = global_var}
...
```{r hmp level one ram computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 20: The Voronoi Tessellation with the heat map overlaid over the variable ram in the ’computers’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.results,
  trainComputers,
  child.level = 1,
...
```{r hmp level one screen computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 21: The Voronoi Tessellation with the heat map overlaid over the variable screen in the ’computers’ dataset',eval = global_var}
muHVT::hvtHmap(
  hvt.results,
  trainComputers,
  child.level = 1,
...
```{r hmp level one ads computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 22: The Voronoi Tessellation with the heat map overlaid over the variable ads in the ’computers’ dataset',eval = global_var}
...
```{r,message=FALSE,warning=FALSE,fig.cap='Figure 23: Mean Absolute Difference'}
hist(combined$diff, breaks = 10, col = "blue", main = "Mean Absolute Difference", xlab = "Difference")
``` 
