...
This package also additionally provides functions for computing Sammon’s projection and plotting the heat map of the variables on the tiles of the tessellations.
...
* __`nclust`__  - An integer indicating the number of cells per hierarchy (level)
