...
set.seed(240)
hvt.results <- list()
hvt.results <- HVT::HVT(dataset_updated_train,
                          n_cells = 1035,
                          depth = 1,
                          quant.err = 0.2,
                          projection.scale = 10,
...
plotDiag() function can be used to print diagnostic plots for HVT model
or HVT prediction.

The plotDiag() function for HVT Model provides 5 diagnostic plots which
are as follows:
...
The plotDiag() function can be called for prediction object as well.
