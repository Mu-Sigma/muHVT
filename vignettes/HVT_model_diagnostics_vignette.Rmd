...
```{r, dataPlots function, purl = FALSE,message=FALSE,warning=FALSE, fig.height=6, fig.width=6,fig.align='center'}
dataPlots(dataset_updated)
```
...
dataPlots(dataset_updated_train)
...
dataPlots(dataset_updated_test)
