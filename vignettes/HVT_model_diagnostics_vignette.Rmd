...
three to 10 dimensions. Geo Zoo contains regular or well-known objects, eg cube and sphere, and some abstract objects, e.g. Boy's surface, Torus and Hyper-Torus.
...
train data. This plot is obtained by scoring the train data
...
that at **0.22** Mean Absolute Deviation value the percentage anomalies
