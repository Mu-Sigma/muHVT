...
* __`mad.threshold`__ - A numeric values indicating the permissible Mean Absolute Deviation. It determines how extreme a deviation from the median has to be in order to be considered an novelty.
