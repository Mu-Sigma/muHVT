...
map_A <- list()
map_A <-HVT::trainHVT(trainComputers,
                n_cells = 440,
                quant.err = 0.2,
                depth = 1,
                distance_metric = "L1_Norm",
...
Let's have a look at the function `plotHVT` that we will use to overlay features as heatmap.

```{r hvt_mapA plotHVT,echo = TRUE, eval= FALSE}
...
map_B <- HVT::trainHVT(dataset_with_novelty,
                  n_cells = 12 ,   #6
                  depth = 1,
                  quant.err = 0.2,
                  projection.scale = 10,
...
map_C <- list()
mapA_scale_summary = map_A[[3]]$scale_summary
map_C <- HVT::trainHVT(dataset_without_novelty,
                  n_cells = 10,
                  depth = 2,
                  quant.err = 0.2,
                  projection.scale = 10,
