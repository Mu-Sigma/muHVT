...
For more detailed information on Data Compression please refer to [section 4](https://htmlpreview.github.io/?https://github.com/Somya545/muHVT/blob/master/vignettes/muHVT_vignette4.html#voronoi- tessellations) of this vignette.
...
# Example Usage: Predictions using the predictHVT on Personal Computers Dataset.
...
```{r plot level one computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 9: The Voronoi Tessellation for layer 1 shown for the 1001 cells in the dataset ’computers’',eval = global_var}
...
For more detailed information on Data Compression please refer to [section 5](https://htmlpreview.github.io/?https://github.com/Somya545/muHVT/blob/master/vignettes/muHVT_vignette4.html#prediction) of this vignette.
...
* **Example Usage2: Example Usage of Predictions using the predictHVT on Personal Computers Dataset**

*  We have considered computers dataset for generating predictions to see which cell and level each point belongs to.

*  We construct a compressed HVT map using the HVT() on the training dataset by setting __`n_cells`__ to 1001 and  __`quant.error`__ to 0.1
