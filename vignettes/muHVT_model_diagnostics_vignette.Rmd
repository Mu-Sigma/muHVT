...
### 7.2 Deleting Irrelevant Columns
...
### 7.3 Formatting and Renaming Columns
...
### 7.4  Changing Data Type of Columns
...
### 7.5 Checking and Removing Duplicates
...
### 7.6 List of Numerical and Categorical Column Names
...
### 7.7 Filtering Dataset for Analysis
...
### 7.10 Check for Singularity {#singularity}
...
### 7.11 Selecting only Numeric Cols after Dummification
...
As seen in the above table, 98% of the cells have a quantization error below the 
...
### 11.1.1 Mean Absolute Deviation based Calibration: HVT Model \| Train Data
...
### 11.1.2 Minimum Intra-DataPoint Distance Plot: Train Data
...
### 11.1.3 Minimum Intra-Centroid Distance Plot: HVT Model | Train Data
...
### 11.1.4 Distribution of Number of Observations in HVT Cells
...
### 12.3 Transformation of Categorical Features
...
### 13.1 Quantization Error Comparison (Train vs. Test)
...
### 13.3 Anomalous Test Cells (highlighted) in Fitted HVT Map

The plot below shows anomalous cell(s) with color indicating
