---
title: "HVT: Analyzing and Visualizing Timeseries data using Flowmap"
author: "Pon Anu Reka"
date: "`r Sys.Date()`"
output:
...
list.of.packages <- c("dplyr", "kableExtra", "geozoo", "plotly", "purrr", "sp", "HVT", "data.table", "gridExtra","plyr", "grid", "ggforce", "reactable", "markovchain", "reshape", "gganimate", "gapminder", "animation", "magick", "tidyr", "jpeg", "ggpubr", "stringr")
...
The objective of this notebook is to use the Lorenz attractor dataset to determine the dynamics of the system and to gain insights into the behavior and characteristics of a chaotic system.
