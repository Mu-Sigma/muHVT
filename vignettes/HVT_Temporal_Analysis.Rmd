...
```{r, plot tratime,  warning = FALSE, message=FALSE, fig.align='center',fig.width=9.2, fig.height= 7}
edaPlots(trainDataset, time_column = "t", output_type = "timeseries", n_cols = 5)
```

</br>

```{r plot tratab, warning = FALSE, message=FALSE}
...
```{r plot trahist,figures-side,  warning = FALSE, message=FALSE}
...
```{r plot trabox,figures-side, warning = FALSE, message=FALSE}
...
```{r plot tracor,fig.width = 7, fig.height = 5, fig.align='center', warning = FALSE, message=FALSE}
...
**Data Distribution**
```{r, plot testime,  warning = FALSE, message=FALSE, fig.align='center',fig.width=9.2, fig.height= 7}
edaPlots(testDataset, time_column = "t", output_type = "timeseries", n_cols = 5)
```

</br>

```{r plot testab, warning = FALSE, message=FALSE}
...
```{r plot teshist,figures-side, warning = FALSE, message=FALSE}
...
```{r plot tesbox,figures-side, warning = FALSE, message=FALSE}
...
```{r plot tescor,fig.width = 7, fig.height = 5, fig.align='center', warning = FALSE, message=FALSE}
...
displayTable(data =scoring$scoredPredictedData, columnName= 'Quant.Error', 
             value = 0.1, tableType = "summary", limit =100, scroll = T)
```
