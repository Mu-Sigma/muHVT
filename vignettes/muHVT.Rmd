...
* __`show.points`__ - A boolean indicating if the centroids should be plotted on the tesselations. (default = FALSE)
...
The heatmap for `screen` variable for different cells at level 1 can be seen in the plot below.
