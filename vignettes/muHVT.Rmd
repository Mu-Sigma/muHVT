...
## muHVT v(23.06.3.5) | What's New?

07th June, 2023

In this version of muHVT package, the following new features and enhancements have been introduced
...
### Installation of muHVT v(23.06.3.5)
...
This package now additionally provides functionality to predict based on a set of maps using `mlayerHVT` to monitor entities over time.
...
2. **Remove outlier cells:** Manually identify and remove the outliers cells from the dataset using the removeOutliers() function (Map B)
...
Let us try to understand the steps briefly :
