...
ggplotHVT(hvt.results,line.width = c(1.5), color.vec = c("#26532B"))
```
...
ggplotHVT(hvt.results, line.width = c(1.5, 0.8), color.vec = c("#26532B","#ADB2D3"))
...
ggplotHVT(hvt.results,line.width = c(1.5,0.8,0.2),color.vec = c("#26532B","#ADB2D3","#BFA89E"))
```
