...
For more information on vector quantization, refer the following [link](https://github.com/Mu-Sigma/HVT/blob/restructure/vignettes/HVT_vignette.html).
...
As this is already done in  [**HVT Vignette:**](https://github.com/Mu-Sigma/HVT/blob/restructure/vignettes/HVT_vignette.html)  please refer for more information.
