...
-   **`hvt_mapB`** - Result obtained from trainHVT function while performing hierarchical vector quantization on novelty data. Novelty data is a subset of the training data obtained as a result of removeNovelty function (1st element).

-   **`hvt_mapC`** - Result obtained from trainHVT function while performing hierarchical vector quantization on data without novelty. This data is a subset of the training data obtained as a result of removeNovelty function (2nd element).
