...
```{r,message=FALSE,warning=FALSE,fig.cap='Figure 22: Mean Absolute Difference', fig.height=4, fig.width=6}
...
-   We construct a compressed HVT map (torus_mapA) using the trainHVT() on the training dataset by setting **`n_cells`** to 900 and **`quant.error`** to 0.1 and we were able to attain a compression of 85%.
