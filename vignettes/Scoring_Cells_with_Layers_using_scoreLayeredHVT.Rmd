...
# Example : HVT with the Torus dataset
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 2: The Voronoi Tessellation for layer 1 (map A) shown for the 900 cells in the dataset ’computers’'}
plotHVT(torus_mapA,
        line.width = c(0.4), 
        color.vec = c("#141B41"),
        centroid.size = 0.01,
...
```{r hvt_mapA hmp level one price computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 4: The Voronoi Tessellation with the heat map overlaid for variable ’x’ in the ’torus’ dataset',eval = global_var}
...
```{r hvt_mapA hmp level one speed computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 5: The Voronoi Tessellation with the heat map overlaid for variable ’y’ in the ’torus’ dataset',eval = global_var}
...
```{r hvt_mapA hmp  level one hd computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 6: The Voronoi Tessellation with the heat map overlaid for variable ’z’ in the ’torus’ dataset',eval = global_var}
...
-   Number of Cells at each Level = 6
-   Maximum Depth = 1
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 14: The Voronoi Tessellation for layer 2 (map C) shown for the 347 cells in the dataset ’torus’ at level 2'}
plotHVT(torus_mapC,
...
```{r hvt_mapC hmp level one n computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 15: The Voronoi Tessellation with the heat map overlaid for feature x in the ’torus’ dataset' , eval = global_var}
...
```{r hvt_mapC hmp level one price computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 16: The Voronoi Tessellation with the heat map overlaid for features y in the ’torus’ dataset',eval = global_var}
...
```{r hvt_mapC hmp level one speed computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 17: The Voronoi Tessellation with the heat map overlaid for features z in the ’torus’ dataset',eval = global_var}
...
-   Based on the output of the above step, we manually identify the novelty cell(s) from the plotted map A. For this dataset, we identify the 69th,246th,279th,293rd,573rd,883rd,706th,745th cells as the novelty cell.
...
-   The data with novelty is then passed to the trainHVT() to construct another HVT map (torus_mapB). But here, we set the parameters **`n_cells`** = 6, **`depth`** = 1 etc. when constructing the map.

-   The data without noveltY is then passed to the trainHVT() to construct another HVT map (torus_mapC). But here, we set the parameters **`n_cells`** = 347, **`depth`** = 2 etc. when constructing the map.
