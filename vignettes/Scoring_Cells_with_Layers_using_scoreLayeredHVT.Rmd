...
For more information on vector quantization, refer the following [link](https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/HVT_vignette.html).
...
As this is already done in  [**HVT Vignette:**](https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/HVT_vignette.html)  please refer for more information.
...
plotHVT <-(hvt.results, line.width, color.vec, pch1 = 21, centroid.size = 1.5, 
           title = NULL, maxDepth = NULL, child.level, hmap.cols,cell_id,
