...
DT::datatable(hvt_mapA[[3]]$compression_summary, class = 'cell-border stripe', options = list(scrollX = TRUE))
```
...
DT::datatable(hvt_mapC[[3]]$compression_summary, class = 'cell-border stripe', options = list(scrollX = TRUE))
```
